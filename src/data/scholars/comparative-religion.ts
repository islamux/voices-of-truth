...
export const comparativeReligionScholars: Scholar[] = [
  ...
  },
  {
    ...
    socialMedia: [
        ...
        { platform: 'Patreon', link: 'https://www.patreon.com/zaynaldeen', icon: 'SiPatreon' }
    ],
    country: { en: 'Libya', ar: 'ليبيا' },
    language: ['Arabic'],
    avatarUrl: '/avatars/zain_khairallah.png',
    bio: {
      en: 'Zain al-Din bin Khairallah al-Awjali is a young Muslim from Benghazi, Libya. He is a student of knowledge and works as a teacher of Islamic education and the Holy Quran in Libyan schools. His goal is to call to God and respond to all those who lie about Islam. He has several accounts, thanks to God Almighty. Praise be to God, by whose grace good deeds are accomplished. His Facebook page is called Zain Khairallah Main Page. For those who want to provide financial support to Zain Khairallah, here is the Patreon link: https://www.patreon.com/zaynaldeen',
      ar: 'زين الدين بن خير الله الأوجلي شاب مسلم ليبي من مدينة بنغازي طويلب علم أعمل كمدرس للتربية الإسلامية والقرآن الكريم في المدارس الليبية هدفي الدعوة إلى الله والرد على كل من يكذب على الإسلام ولدي حساب عد بفضل الله تعالى والحمد لله الذي بنعمته تتم الصالحات\nصفحتي على الفيس اسمها زين خير الله الصفحة الرئيسية \nلمن أراد الدعم المادي لزين خير الله رابط الباتريون https://www.patreon.com/zaynaldeen'
    },
    category: { en: 'Comparative Religion', ar: 'مقارنة أديان' }
  },
  {
